...
class Derived : protected Base              /// Base Class is Protected for Derived
{
    private :
            int  P , Q ;
            ...
            void DFun1()
            {
                cout<<"Private Derived Function Called...";
    ...
    protected:
            ...
            void DFun2()
            {
                 cout<<"Protected Derived Function Called...";
    ...
    public:
            ...
            void DFun3()
            {
                 cout<<"Public Derived Function Called...";
                X = 1000;
                Y = 2000;
...
int main()
{
   ...
   /// obj2.BFun2();                    /// Not Accessible
    ...
    ///obj2.BFun3();                    ///Not Accessible bcz Access Specifier of Inheritance
    getch();
